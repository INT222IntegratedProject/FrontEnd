        ...
        <div class="container mx-auto px-6 py-3 pt-24">
            ...
            <nav :class="isOpen ? '' : 'hidden'" class="sm:flex sm:justify-center sm:items-center mt-4">
                <div class="flex flex-col sm:flex-row">
                    <a class="mt-3 text-gray-600 hover:underline sm:mx-3 sm:mt-0" href="#">H&M</a>
                    <a class="mt-3 text-gray-600 hover:underline sm:mx-3 sm:mt-0" href="#">Uniqlo</a>
                    <a class="mt-3 text-gray-600 hover:underline sm:mx-3 sm:mt-0" href="#">Zara</a>
                </div>
            </nav>
            ...
            <span class="absolute inset-y-0 left-0 pl-3 flex items-center">
                ...
                <input
                v-model="search"
                 class="w-full border rounded-md pl-10 pr-4 py-2
                 focus:border-blue-500 focus:outline-none focus:shadow-outline" type="text" placeholder="Search">
            </div>
        </div>
    </header>
  <body
...
export default {
  ...
  data() {
    return {
      search:'',
      urlAllProduct: "https://walkincloset.ddns.net/backend/Products/GetProducts",
      allProductData: [],
    };
  },
  props: ["product"],
